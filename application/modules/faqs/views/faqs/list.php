			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                        	<button class="btn btn-sm btn-primary m-r-5" type="button" onclick="window.location.href='<?php echo site_url('faqs/backend/form');?>';" style="margin-bottom: 10px;">Add</button>
								...
								<table id="data-table" class="table table-striped table-bordered">
						            <thead>
						                <tr>
						                    ...
						                    <th>Question</th>
						                    <th class="select-filter">Answer</th>
						                    <th>Action</th>
						                </tr>
						            </thead>
						            <tbody>
	...
	<script>
		$(document).ready(function() {
    		...
    		var table = $('#data-table').DataTable({ 
		        ...
		        "ajax": {
		            "url": "<?php echo site_url('faqs/backend/server_processing');?>",
		            "type": "POST"
		        },
