...
<head>
	...
	<meta charset="utf-8" />
	<title>La secta Beauty :: <?php if(!empty($title)) { echo str_replace("_", " ", $title); } ?></title>
		...
		<div id="header" class="header navbar navbar-default navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					<a href="<?php echo site_url();?>" class="navbar-brand"><span class="navbar-logo"></span> La secta Beauty</a>
