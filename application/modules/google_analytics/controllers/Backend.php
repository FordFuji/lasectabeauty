...
class Backend extends CI_Controller {
	...
	public function __construct() {
		...
		$this->load->model('google_analytics/model_google_analytics');
		$this->load->model('template_main/model_template_main');
		//$this->load->library('datatables');
		$this->load->library('table');
		$this->load->helper('form');
		$this->path_upload = FCPATH.'uploads/google_analytics/';
	...
	public function index(){
		...
		$this->load->view('google_analytics/google_analytics/form', $data);
	}
}
?>