			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="panel-body">
							<form action="<?php echo site_url('home/backend/instagram_save_update/');?>" method="post" enctype="multipart/form-data" class="form-horizontal">
							<div class="form-group">
					            <label class="col-md-3 control-label">Instagram</label>
					            <div class="col-md-9">
                       				<input type="text" name="instagram_name" id="instagram_name" class="form-control" value="<?php if(!empty($row)) echo $row->instagram_name;?>">	
					            </div>
					        </div> 
					        <div class="form-group">
