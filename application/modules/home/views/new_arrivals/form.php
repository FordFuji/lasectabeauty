			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="panel-body">
							<form action="<?php echo site_url('home/backend/new_arrivals_save_update/');?>" method="post" enctype="multipart/form-data" class="form-horizontal">
							<div class="form-group">
					            <label class="col-md-3 control-label">Link</label>
					            <div class="col-md-9">
                       				<input type="text" name="new_arrivals_link" id="new_arrivals_link" class="form-control" value="<?php if(!empty($row)) echo $row->new_arrivals_link;?>">
					            </div>
					        </div> 
					        <div class="form-group">
