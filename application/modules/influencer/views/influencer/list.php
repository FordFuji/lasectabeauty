			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                        	<button class="btn btn-sm btn-primary m-r-5" type="button" onclick="window.location.href='<?php echo site_url('influencer/backend/influencer_form');?>';" style="margin-bottom: 10px;">Add</button>
	...
	<script>
		$(document).ready(function() {
    		...
    		var table = $('#data-table').DataTable({ 
		        ...
		        "ajax": {
		            "url": "<?php echo site_url('influencer/backend/influencer_server_processing');?>",
		            "type": "POST"
		        },
