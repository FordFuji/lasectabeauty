			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                        	<button class="btn btn-sm btn-primary m-r-5" type="button" onclick="window.location.href='<?php echo site_url('data_product/backend/product_form');?>';" style="margin-bottom: 10px;">Add</button>
								...
								<table id="data-table" class="table table-striped table-bordered">
						            <thead>
						                <tr>
						                	...
						                	<th>Product(Ar)</th>
						                	<th>Image</th>
						                	<th>Product Before Discount Price</th>
						                	<th>Price</th>
						                    <th>Action</th>
						                </tr>
						            </thead>
                    		...
                    		<input type="button" name="export_excel" value="Export Excel" onclick="exportExcelProduct();">
                        </div>
                        </form>
                    </div>
                    <!-- end panel -->
	...
	<script>
		$(document).ready(function() {
    		...
    		var table = $('#data-table').DataTable({ 
		        ...
		        "ajax": {
		            "url": "<?php echo site_url('data_product/backend/product_server_processing');?>",
		            "type": "POST"
		        },
		...
		function exportExcelProduct() {
			window.location.href = '<?php echo site_url("data_product/backend/export_excel_product");?>';
		}
	</script>
</body>
</html>
