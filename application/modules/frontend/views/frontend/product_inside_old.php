                    ...
                    <div class="crop_bread">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo site_url('frontend/path/product_index/'.$row->category_id);?>"><?php if(!empty($row)) echo $row->category_name;?></a></li>
                                <li class="breadcrumb-item active" aria-current="page"><?php if(!empty($row)) echo $row->sub_category_name;?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
?>
                        <section id="color<?php echo $ii;?>" class="simplegallery">
...
?>
                                    <li>
                                        <a href="<?php echo base_frontend('images/productinside_test.png');?>" data-fancybox="images">
                                            <img src="<?php echo base_frontend('images/productinside_test.png');?>" alt="" />
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_frontend('images/productinside_test.png');?>" data-fancybox="images">
...
?>
                        <section id="color02" class="simplegallery">
                            <div class="flexslider mb-3">
                                <ul class="slides">
                                    <li>
                                        <a href="<?php echo base_frontend('images/productinside_test2.png');?>" data-fancybox="images">
                                            <img src="<?php echo base_frontend('images/productinside_test2.png');?>" alt="" />
                                        </a>
                    ...
                    <div class="product_inside_details">
                        <div class="row">
                            <div class="col-10 col-xl-9">
                                <h2><?php if(!empty($row)) echo $row->product_name;?></h2>
                                <h4>$<?php if(!empty($row)) echo number_format($row->product_price, 2, '.', ',');?></h4>
                            </div>
                            <div class="col-2 col-xl-3">
                                <div class="side_sharelike">
                                    <div class="wishlist_product"><a href="javascript:addWishList('<?php echo $row->product_id;?>');" class="tooltip-bottom" data-tooltip="Add to Favorite"><img src="<?php echo base_frontend('images/wishlist_black.svg');?>"></a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <hr>
                        <div class="mt-3">
                            <div class="multitext_color"><b>Color : <?php if($check == true) { echo 'None'; } ?></b></div>
...
<style>
    #color<?php echo $ii;?> {
        border: 0px !important;
                ...
                <a href="#color<?php echo $ii;?>" id="color<?php echo $ii;?>" class="colorPick">
                </a>
<?php
        } else {
?>
                <a href="#color<?php echo $ii;?>" id="color<?php echo $ii;?>" class="colorPick">
                    <div class="color<?php echo $ii;?>"></div> <span> <?php echo $c->color_name;?></span>
                </a>
                No. <?php echo $i;?>
<?php                
        }
...
?>
                            <div class="row">
                                <div class="col">
                                    <div class="multitext_color"><b>Weight : </b> <?php if(!empty($row)) echo $row->product_weight;?> Gram</div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-6 col-xl-8 mt-3 mt-md-0">
                                <a href="javascript:insertCart();" class="btn btn-info">Add to bag</a>
                            </div>
                        </div>
                        ...
                        <div class="accordion">
                            <li> <a>Description</a>
                                <p><?php if(!empty($row)) echo $row->product_description;?></p>
                            </li>
                            <li> <a>Ingredient</a>
                                <p><?php if(!empty($row)) echo $row->product_ingredient;?></p>
                            </li>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="item box">
                        <div class="box_bestseller product">
                            ...
                            <a href="<?php echo site_url('frontend/path/product_inside/'.$r->product_id);?>"><img src="<?php echo base_url('uploads/product/'.$r->product_image);?>" class="img-fluid"></a>
                                <div class="wishlist_product"><a href="javascript:addWishList('<?php echo $product_id;?>');" class="tooltip-bottom" data-tooltip="Add to Favorite"><img src="<?php echo base_frontend('images/wishlist_black.svg');?>"></a></div>
                            </div>
...
?>
    ...
    <script>
        ...
        function changeImageColor(color_id) {
            $.post('<?php echo site_url('frontend/path/ajaxImageColor');?>', { color_id: color_id, product_id: '<?php echo $product_id;?>' }, function(data) {
                $("#image_color_" + color_id).html(data);
            });
        }
    </script>
