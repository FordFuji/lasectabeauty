            ...
            <div class="row mt-5 mb-5">
                <div class="col">
                    <div class="title_section">
                     	<?php echo get2Lang($this->session->userdata('lang'), 'Shipping', 'الشحن');?>
                    </div>
                ...
                <div class="col">
                   <div class="text_content">
                    <div class="content mCustomScrollbar">
                    	<?php if(!empty($row)) echo get2Lang($this->session->userdata('lang'), $row->shipping_detail, $row->shipping_detail_ar);?>
