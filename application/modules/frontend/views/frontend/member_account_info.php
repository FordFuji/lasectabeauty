            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="backlink d-block d-sm-block d-md-block d-lg-none d-xl-none">
                        <a href="<?php echo site_frontend('member_account.php');?>"><?php echo get2Lang($this->session->userdata('lang'), 'Back', 'عودة');?></a>
                    </div>
                    <div class="title_section_cart">

                        <div class="row">
                            <div class="col-lg-8">
                                <h5><?php echo get2Lang($this->session->userdata('lang'), 'Account information', 'معلومات الحساب');?></h5>
                            </div>
                            <div class="col-lg-4">
                                <div class="backlink">
                                    <a href="<?php echo site_frontend('member_account.php');?>"><?php echo get2Lang($this->session->userdata('lang'), 'Back', 'عودة');?></a>
                    ...
                    <div class="bgwhite_shadow2">
                        <div class="formaddress">
                            ...
                            <div class="row">
                                <div class="col-6 col-lg-6"> <span class="labelname"><?php echo get2Lang($this->session->userdata('lang'), 'First Name', 'الاسم الأول');?></span>
                                    <input id="member_first_name" name="member_first_name" type="text" class="form-control input-md" value="<?php if(!empty($row)) echo $row->member_first_name;?>" required> </div>
                                <div class="col-6 col-lg-6"> <span class="labelname"><?php echo get2Lang($this->session->userdata('lang'), 'Last Name', 'الاسم الأخير');?></span>
                                    <input id="member_last_name" name="member_last_name" type="text" class="form-control input-md" value="<?php if(!empty($row)) echo $row->member_last_name;?>" required> </div>
                            </div>
                            <div class="row">
                                <div class="col-6 col-lg-6"> <span class="labelname"><?php echo get2Lang($this->session->userdata('lang'), 'Phone Number', 'رقم الجوال');?></span>
                                    <input id="member_phone_number" name="member_phone_number" type="text" value="<?php if(!empty($row)) echo $row->member_phone_number;?>" class="form-control input-md" required> </div>
                                <div class="col-6 col-lg-6"> <span class="labelname"><?php echo get2Lang($this->session->userdata('lang'), 'Email Address', 'عنوان البريد الإلكتروني');?></span>
                                    <input id="member_email" name="member_email" type="text" value="<?php if(!empty($row)) echo $row->member_email;?>" class="form-control input-md" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <span class="labelname"><?php echo get2Lang($this->session->userdata('lang'), 'Gender', 'النوع');?></span>
                                    <select id="member_gender" name="member_gender" class="form-control arrow_down" required>
                                        <option value=""><?php echo get2Lang($this->session->userdata('lang'), 'Please select', 'من فضلك اختر');?></option>
                                        <option value="Male" <?php if(!empty($row) and $row->member_gender == 'Male') echo 'selected';?>><?php echo get2Lang($this->session->userdata('lang'), 'Male', 'ذكر');?></option>
                                        <option value="Female" <?php if(!empty($row) and $row->member_gender == 'Female') echo 'selected';?>><?php echo get2Lang($this->session->userdata('lang'), 'Female', 'أنثى');?></option>
                                    </select>
                                </div>
