...
<body>
  ...
  <div class="backlink d-block d-sm-block d-md-block d-lg-none d-xl-none">
                    ...
                    <div class="title_section_cart">
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <h5><?php echo get2Lang($this->session->userdata('lang'), 'Change Password', 'تغيير كلمة السر');?></h5>
                            </div>
                            <div class="col-lg-4">
                                <div class="backlink">
                                    <a href="<?php echo site_frontend('member_account.php');?>"><?php echo get2Lang($this->session->userdata('lang'), 'Back', 'عودة');?></a>
                    ...
                    <div class="bgwhite_shadow2">
                        <div class="formaddress">
                           <form action="" method="post">
                            <div class="row">
                                <div class="col"> <span class="labelname"><?php echo get2Lang($this->session->userdata('lang'), 'Current Password', 'كلمة السر الحالية');?></span>
                                    <input id="member_password" name="member_password" type="password" class="form-control input-md" required>
                                </div>
                            </div>
                             <div class="row">
                                <div class="col"> <span class="labelname"><?php echo get2Lang($this->session->userdata('lang'), 'New Password', 'كلمة السر الجديدة');?></span>
                                    <input id="member_password_new" name="member_password_new" type="password" class="form-control input-md" required>
                                </div>
                            </div>
                             <div class="row">
                                <div class="col"> <span class="labelname"><?php echo get2Lang($this->session->userdata('lang'), 'Confirm New Password', 'تأكيد كلمة السر الجديدة');?></span>
                                    <input id="member_password_confirm" name="member_password_confirm" type="password" class="form-control input-md" required>
                                </div>
                            </div>
